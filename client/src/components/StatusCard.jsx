...
const StatusCard = ({title, value, icon, bgIcon='bg-gray-700', iconColor='text-white', gradient='from-gray-900 to-gray-800', description=''}) => {
    return (
        <div className={`rounded-lg shadow-lg p-6 border bg-gradient-to-r ${gradient}  border-gray-800 transform hover:scale-105 transition-all ${bgIcon}`}>
            <div className='flex justify-between items-start}'>
                ...
                {/* Icon */}
                <div className={`p-3 rounded-lg flex items-center justify-between ${bgIcon}`}>
                    {/* I will update it */}
