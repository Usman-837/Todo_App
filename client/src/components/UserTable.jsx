            ...
            {users.map((u, indx) => (
              <tr className="hover:bg-gray-800 transition-colors">
                ...
                <td className="px-6 py-4 text-sm">
                  <span className={`px-3 py-1 rounded-full text-xs font-semibold ${u.status === "Active" ? "bg-green-500 text-gray-900" : "bg-red-500 text-white"}`}>
                    {u.status}
                  </span>
                </td>
                ...
                <td className="px-6 py-4 text-center">
                  <div className="flex justify-center gap-2">
                    <button className="flex items-center gap-1 px-3 py-1.5 text-sm bg-green-500 text-gray-900 rounded-lg hover:bg-green-400 transition-all font-semibold" onClick={() => onEdit(u)}>
                      <Edit size={16} /> Edit
                    </button>
                    <button className="flex items-center gap-1 px-3 py-1.5 text-sm bg-red-500 text-white rounded-lg hover:bg-red-400 transition-all font-semibold" onClick={() => onDelete(u._id)}>
            ...
            <div className="flex gap-2">
              ...
              {[...Array(totalPages)].map((_, i) => {
                ...
                if (
                  ...
                  return <button className={`px-3 py-2 rounded-lg ${currentPage === p ? "bg-green-500 text-gray-900 font-semibold" : "bg-gray-700 border-gray-600 text-gray-300 hover:bg-gray-600"}`} onClick={() => onPageChange(p)}>{p}</button>;
